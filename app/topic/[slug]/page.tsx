      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {articles.map((article, i) => (
          <a
            ...
            className="group bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-white/5 hover:border-blue-400 dark:hover:border-blue-500/40 rounded-2xl p-5 flex flex-col gap-3 transition-all hover:bg-white dark:hover:bg-gray-900"
          >
            ...
            <h2 className="text-sm font-semibold text-gray-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-300 transition-colors leading-snug line-clamp-2">
              {article.title}
            </h2>
            {article.description && (
            ...
            <div className="flex items-center gap-1 text-xs text-gray-400 dark:text-gray-600 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors mt-auto">
              Lire l&apos;article
